...
csvout = './CSVPS/PS_PartyPrecinct.csv'
    ...
    for okrsek in vsechnyokrsky:
        ...
        if len(cisloKand) != 0:
            for strana in range(len(cisloKand)):
                ...
                if procentaA != "-":
                    row = [vesnice[3], vesnice[1].encode('utf-8','replace'), vesnice[0], hlasyA,  procentaA, nazevKandA, cisloKandA, vesnice[4], okrseknum, urldat]
                    writer.writerow(row)