...
data <- read.table("/Users/petrbouchal/Documents/Aptana Studio 3 Workspace/Volby_CZ/CSVKraje/Kraje_KandidatiKrajeaDetaily.csv",header=T,sep=",",quote="\"", encoding="UTF-8")
