...
csvout = './/Kraje_PartyReg_' + electyear + '_' + electtype + '.csv'
...
for kraj in kraje:
    urldat = 'http://volby.cz/pls/kz' + electyear + '/kz311?xjazyk=CZ&xdatum=' + electdatestring + '&xkraj=' + str(kraj)
    ...
    if len(cisloKand) != 0:
        for strana in range(len(cisloKand)):
            ...
            hlasyA = hlasyB[0].strip().replace(u' ', u'').replace(u'\xa0', u'')
