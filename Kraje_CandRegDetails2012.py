...
csvout = './CSVKraje/Kraje_CandRegDetails2012.csv'
...
for partaj in vsechnykandidatky:
    for kraj in vsechnykraje:
        urldat = 'http://volby.cz/pls/kz2012/kz111?xjazyk=CZ&xdatum=20121012&xkraj=' + str(kraj) + '&xstrana=' + str(partaj) + '&xv=1&xt=1'
        print urldat
